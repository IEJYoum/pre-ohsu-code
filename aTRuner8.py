...
import aThinker8 as thinker #athinker5 should also work
import numpy as np
...
def main(trainf,testf): #first get better pints and data representation coming out
    ...
    np.savetxt("aTRuner8 performance data NP 1.csv",performanceA)
...
def makePerformanceData(actionL,performance):
    datapoint = []
    datapoint.append(actionL[0]) #time per each function generation #.8
    
    datapoint.append(actionL[1][0]) #12                                 
    datapoint.append(actionL[1][1]) #30
    datapoint.append(actionL[1][2]) #-2
    datapoint.append(actionL[1][3]) #0
    datapoint.append(actionL[1][4]) #-.7
    datapoint.append(actionL[1][5]) #1
    
    datapoint.append(actionL[2][0]) #1
    datapoint.append(actionL[2][1]) #-1
    datapoint.append(actionL[2][2]) # -1
    datapoint.append(actionL[2][3]) # cant tell.. most data around 0
    datapoint.append(actionL[2][4]) # most data around 0
    datapoint.append(actionL[2][5]) # 0 to 20
    
    datapoint.append(actionL[3]) #axis
    datapoint.append(actionL[4]) #time per sweep #1,4,or6
